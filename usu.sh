...
do
    echo "I got:$col1|$col2"
        ...
        samba-tool user create $LOGIN zsx100* --given-name=$NOMBRE --surname=$APELLIDOS --must-change-at-next-login --u>        #Se hace miembro del grupo correspondiente al usuario
